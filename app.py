...
**5. Recomenda-se a pesquisa das cotas dos documentos de interesse no site do Projeto Resgate, fonte original das informações organizadas aqui: [resgate.bn.gov.br](https://resgate.bn.gov.br)**""")
st.divider()
