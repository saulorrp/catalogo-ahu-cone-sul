...
def load_data():
    ...
    """
    with open('ahu_sul_catalog.json', 'r', encoding='utf-8') as f:
    ...
    perplexity_renames = {
        ...
        'perplexity_search_data_pais_nascimento': 'pais_nascimento',
...
if st.session_state.show_samples_panel:
    ...
    <div class="panel-header">
        ...
        <p>Ferramenta de selecao de corpus para Linguistica Historica. Os filtros da barra lateral afetam os autores disponiveis.</p>
    </div>
    """, unsafe_allow_html=True)
