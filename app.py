    ...
    for i in range(0, total, batch_size):
        ...
        for _, row in batch.iterrows():
            docs.append({
                ...
                "referencia": str(row.get('reference_code', 'N/A')),
        ...
        if author_docs.empty:
            ...
            for sec_idx in range(num_sections):
                ...
                with st.expander(
                    ...
                    display_df = batch[['ano_isolado', 'new_code', 'extracted_typology', 'description']].copy()
                    display_df.columns = ['Ano', 'Cota', 'Tipologia', 'Resumo']
